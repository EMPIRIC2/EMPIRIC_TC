...
#SBATCH --job-name=test_data_generation_0619-1840
#SBATCH --output=test_data_generation_0619-1840.log
...
python ../TrainingDataGeneration/GenerateTrainingData.py 100 1 0 0 ./Data/ --include_grids

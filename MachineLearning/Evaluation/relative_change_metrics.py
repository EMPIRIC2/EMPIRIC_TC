...
def compute_all_relative_change_pairs(ground_outputs, model_outputs, max_pairs=200):
    ...
    return: maps of the relative errors with the largest 10 mean squared
    errors and the total mean squared error (over all pair results)
    """
    ...
    largest_error_indices = np.argpartition(mean_squared_errors, -n_examples)[
        -n_examples:
    ]

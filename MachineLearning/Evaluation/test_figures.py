...
class TestFigures(unittest.TestCase):
    ...
    def test_ensemble_boxplot(self):
        example_site_ensemble_boxplot_figure({"STORM": get_many_site_values(outputs), "UNet": get_many_site_values(predictions), "UNet 2": get_many_site_values(outputs)})

    def test_example_site_error_boxplot(self):
        plot_example_site_boxplot(outputs, {"UNet 1": predictions, "UNet 2": predictions}, 4)

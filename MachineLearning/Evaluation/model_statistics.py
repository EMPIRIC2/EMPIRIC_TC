...
def kolmogorov_smirnov_statistics(ground_truths, predictions):
    ...
    :param: ground_truths: the outputs from the model being used
    as the baseline (i.e. STORM) (a list of n x m numpy arrays)
    :param: predictions: outputs of the model being
    evaluated (a list of n x m numpy arrays of the same length as ground_truths)
